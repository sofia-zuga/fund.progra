...
document.getElementById('escuela').addEventListener('change', seccionEscuela);


function seccionEscuela() {
    var opciones = document.getElementById('escuela').value;
    ...
    switch (opciones) {
        case "1":
            ...
            document.getElementById("output-txt").innerHTML = "Iniciar sesión para tu sesión en el Area Personal";

            break;

        case "2":
            document.querySelector('.login1').style.display = "block"
            document.getElementById("output-txt").innerHTML = "Iniciar sesión para tu sesión en el Self-Service";
            break;    

        case "3":
            document.querySelector('.login1').style.display = "block"
            document.getElementById("output-txt").innerHTML = "Iniciar sesión para tu sesión en el Centro de Asistencia";
            break;   
